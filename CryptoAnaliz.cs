   ...
   public class CryptoAnaliz
    {
        ...
        public CryptoDataElement_at_mining at_mining_data;
        public Dictionary<string, CryptoDataElement_update> update_data = new Dictionary<string, CryptoDataElement_update>();
        public Dictionary<string, CryptoDataElement_trades> trades_data = new Dictionary<string, CryptoDataElement_trades>();
